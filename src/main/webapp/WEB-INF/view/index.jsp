...
<div class="am-cf admin-main">
    ...
    <div class="admin-content" style="position:relative;">
        <div class="admin-content-main" style="width:70%;position:absoulte;top=0;">
            <!-- 聊天区 -->
        ...
        <!-- 列表区 -->
        <div class="am-panel am-panel-default" style="    position: absolute;width: 30%;
    top: 0px;
    right: 0px;">
    ...
    function showOnline(list){
        ...
        $.each(list, function(index, item){     //添加私聊和视频按钮
            ...
            if('${userid}' != item){    //排除自己
                ...
                +"<button type=\"button\" class=\"am-btn am-btn-xs am-btn-primary am-round\" onclick=\"startVideo('item');\"><span class=\"am-icon-phone\"><span> 视频</button></li>";
            }
            $("#list").append(li);
        });
